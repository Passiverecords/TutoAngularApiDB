...
let DashboardComponent = class DashboardComponent {
    ...
    getHeroes() {
        this.heroService.getHeroes()
            .subscribe(heroes => this.heroes = heroes.slice(0, 5), (error) => {
            alert('ttt');
        });
    }
};
...
let ProfileComponent = class ProfileComponent {
    ...
    ngOnInit() {
        var p = this.auth.userProfile$.subscribe(profile => this.profileJson = JSON.stringify(profile, null, 2));
...
let AuthService = class AuthService {
    constructor(router, apiService) {
        ...
        })).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["shareReplay"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(err => Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["throwError"])(err)));
        this.isAuthenticated$ = this.auth0Client$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["concatMap"])((client) => Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["from"])(client.isAuthenticated())), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(res => this.loggedIn = res));
        this.handleRedirectCallback$ = this.auth0Client$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["concatMap"])((client) => Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["from"])(client.handleRedirectCallback())));
    ...
    getUser$(options) {
        ...
        //   })
        // );
        return this.auth0Client$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["concatMap"])((client) => {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["forkJoin"])(Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["from"])(client.getUser(options)), this.apiService.ping$());
    ...
    localAuthSetup() {
        const checkAuth$ = this.isAuthenticated$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["concatMap"])((loggedIn) => {
            if (loggedIn) {
                return this.getUser$();
            }
    ...
    handleAuthCallback() {
        ...
        if (params.includes('code=') && params.includes('state=')) {
            let targetRoute;
            const authComplete$ = this.handleRedirectCallback$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(cbRes => {
                targetRoute = cbRes.appState && cbRes.appState.target ? cbRes.appState.target : '/';
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["concatMap"])(() => {
    ...
    getTokenSilently$(options) {
        return this.auth0Client$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["concatMap"])((client) => Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["from"])(client.getTokenSilently(options))));
    }
    logout() {
        this.auth0Client$.subscribe((client) => {
...
let HeroService = class HeroService {
    ...
    getHero(_id) {
        const url = `${this.heroesUrl}/${_id}`;
        return this.http.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(_ => this.log(`fetched hero _id=${_id}`)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError(`getHero _id=${_id}`)));
    }
    ...
    addHero(hero) {
        return this.http.post(this.heroesUrl, hero).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])((newHero) => this.log(`added hero w/ _id=${newHero._id}`)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('addHero')));
    }
    /** DELETE: delete the hero from the server */
    deleteHero(hero) {
        const _id = typeof hero === 'number' ? hero : hero._id;
        const url = `${this.heroesUrl}/${_id}`;
        this.http.delete(url).subscribe((success) => console.log(success), (error) => this.handleError('deleteHero'));
    }
    /** PUT: update the hero on the server */
    updateHero(hero) {
        var url = this.heroesUrl + '/' + hero._id;
        return this.http.put(url, hero).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(_ => this.log(`updated hero _id=${hero._id}`)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('updateHero')));
    }
    /**
